...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="/myhome/App/Home/View/Public/Css/select.css" rel="stylesheet" type="text/css" />
        ...
        <link rel="stylesheet" type="text/css" href="/myhome/App/Home/View/Public/Js/jquery-ui/css/pepper-grinder/jquery-ui.min.css">
            ...
            <script type="text/javascript" src="/myhome/App/Home/View/Public/lib/jquery-1.10.2.min.js"></script>
            <script type="text/javascript" src="/myhome/App/Home/View/Public/source/jquery.fancybox.pack.js?v=2.1.5"></script>
            <link rel="stylesheet" type="text/css" href="/myhome/App/Home/View/Public/source/jquery.fancybox.css?v=2.1.5" media="screen" />
            
            <script type="text/javascript" src="/myhome/App/Home/View/Public/Js/common.js"></script>
            <script type="text/javascript" src="/myhome/App/Home/View/Public/Js/jquery.idTabs.min.js"></script>
            <script type="text/javascript" src="/myhome/App/Home/View/Public/Js/select-ui.min.js"></script>
                    ...
                    $.ajax({ 
                        ...
                        success:function(data){
                            ...
                            if(data.info!= null){
                                ...
                                var str=""
                                    str+="<tr class='soData'>";                            
                                    str+="<td class='label'></td><td><span>------------------产品参数详情-----------------</span></td>";
                                    str+="</tr>"; 
                                $.each(data.info,function(key,val){
                                    str+="<tr class='soData'>";                            
                                    str+="<td class='label'>"+key+"</td><td width='530px'><span>"+val+"</span></td>";
                                    str+="</tr>";                                                                                                                       
                                }) 
                                $("#tableAdd").append(str);
                            }
    ...
    <body style="background: none;">
        <input type="hidden" value="/myhome/admin.php?s=/Home/Goods/details" id="url_getTeacher" name="url_getTeacher" />
         <input type="hidden" value="/myhome/admin.php?s=/Home/Goods/del/id/" id="url_ajaxCalendar" name="url_ajaxCalendar" />
        <div class="place">
            <span>位置： </span>
            <ul class="placeul">
        ...
        <div class="rightinfo">
            <form action="" method="post" name ="vform" id="from_sub">
                <div  id="tab2" class="tabson">
                   ...
                   <!--     <li><a href="http://120.24.215.150/Uploads/list/20150104/700_54a8f1a61de59.png"  class="ceshi1" /><img src="http://120.24.215.150/Uploads/list/20150104/700_54a8f1a61de59.png"></a></li>-->
                        <li><label>分类</label>  
                            <div class="vocation">
                ...
                <table class="imgtable">
                    ...
                    <tbody>
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <!--  /myhome/ -->
                                <td class="imgtd"><a href="<?php echo ($vo["suolie_img"]); ?>" class="imgBig" title="<?php echo ($vo["description"]); ?>"><img src="<?php echo ($vo["list_img"]); ?>" width="70px"/></a></td>
                                <td style="cursor:pointer" onclick="showDetail(<?php echo ($vo["goods_id"]); ?>)"><?php echo ($vo["goods_name"]); ?></a></td>
                                <td><?php echo ($vo["price"]); ?></a></td>
                                <td><?php echo ($vo["number"]); ?></td>
                                <td><?php echo ($vo["inventory"]); ?></td>
                             <!--   <td width="40%"><?php echo ($vo["description"]); ?></td> -->
                                <!--   
                                     <td><?php echo (msubstr($vo["description"],0,35,'utf-8',true)); ?></td>
                ...
                <div id="detailDialog">
                    ...
                    <table cellpadding="0" cellspacing="0" border="1" id="tableAdd">
                        <tr>
                            <td width="110px" class="label">商品名字：</td>
                        ...
                        <tr>
                            ...
                            <td width="110px" class="label">商家名称：</td>
                            <td><span id="store_id"></span></td>
                        </tr>
                        <tr>
                            <td class="label">描述：</td>
							<td width="43%" ><span id="description"></span></td>
