...
<body style="background: none;">
  <input type="hidden" value="/myhome/admin.php?s=/Home/Admin/del/id/" id="url_ajaxCalendar" name="url_ajaxCalendar" />
        <div class="place">
           <span>位置： </span>
            <ul class="placeul">
            ...
            <div class="tools">
                <form action="" method="post" name="vform" id="vform">
                        <ul>
                            ...
                            <li>管理员电话:</li>
                            <li><input type="text" value="" class="form-control" name ="mobile" /></li>
                            <li>真实姓名:</li>
                            <li><input type="text" value="" class="form-control" name ="true_name" /></li>
                            <li><span id="select_deve" style="cursor:pointer"><img src="/myhome/App/Home/View/Public/Images/ico06.png" width="25"/></span></li>
                            <a href="<?php echo U('add');?>"><li class="click"><span><img src="/myhome/App/Home/View/Public/Images/t01.png" /></span>添加管理员</li></a>
                        </ul>
                    </form>
            </div>
            ...
            <table class="tablelist">
                ...
                <tbody id="table_ajax_list">
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td width="20px" class="th_default" align="center"><a href="<?php echo U('edit',array(id=>$vo['id']),'');?>" class="divBtn editBtn ui-state-default ui-corner-all" title="编辑" ><span class="ui-icon ui-icon-pencil"></span></a></td> 
