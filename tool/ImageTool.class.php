...
class ImageTool {
    ...
    */
	...
	public static function thumb($dst,$save=NULL,$width=200,$height=200){
		...
		$careatefunc='image'.$dinfo['ext'];
		$careatefunc($tim,$save);
		imagedestroy($tim); 
		imagedestroy($dim); 
		return true;
	}
...
/*
echo ImageTool::water('./home.jpg','./smallfeng.png','home1.jpg',0)?'ok':'no';
echo ImageTool::water('./home.jpg','./smallfeng.png','home2.jpg',1)?'ok':'no';
echo ImageTool::water('./home.jpg','./smallfeng.png','home3.jpg',2)?'ok':'no';
echo ImageTool::water('./home.jpg','./smallfeng.png','home4.jpg',3)?'ok':'no';

*/
//echo ImageTool::thumb('./feng.png','./feng1.png',200,200)?'ok':'no';
//echo ImageTool::thumb('./feng.png','./feng2.png',200,300)?'ok':'no';
//echo ImageTool::thumb('./feng.png','./feng3.png',300,200)?'ok':'no';
